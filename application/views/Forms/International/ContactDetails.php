		...
		if(place.address_components == null) {
    		...
    		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKRhNKbQ5FenPajhUyvBBemUoOwXKsTpE&libraries=places&callback=initAutocomplete" async defer></script>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
			  		<input type="text" class="form-control" name="streetNum" id="street_number" placeholder="Street number" value=""  />
					</div>
				</div>
				<div class="form-group">
					<label for="route" class="col-lg-2 control-label">Street Name *</label>
					<div class="col-lg-10">
			  		<input type="text" class="form-control" name="streetName" id="route" placeholder="Street address" value="" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
			  		<input type="text" class="form-control" name="locality" id="locality" placeholder="City / Town" value="" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
			  		<input type="text" class="form-control" name="administrative_area_level_1" id="administrative_area_level_1" placeholder="Region" value="" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
			  		<input type="text" class="form-control" name="postal_code" id="postal_code" placeholder="Post code" value="" />
					</div>
				</div>
  			...
  			<script>
				...
				<div class="input-group col-lg-offset-2 col-lg-10">
                    <button class="btn btn-default" id="nextButton" type="button" onclick="contactDetails()">Next Section</button>
                </div>
			</form>
		</div>
	</div>
