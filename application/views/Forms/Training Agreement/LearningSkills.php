    ...
    <div class="row">
		...
		<div class="panel panel-default">
			...
			<div class="form-group col-lg-12">
				...
				<input class="form-control" name="assessmentProvider" id="assessmentProvider" value=""/>
			</div>
			...
			<div class="form-group col-lg-12">
				...
				<input placeholder="Learning Difficulty" class="form-control" name="learningDifficultyDescription" id="learningDifficultyDescription" value=""/>
			</div>
        ...
        <div class="input-group col-lg-offset-2 col-lg-10">
					<button class="btn btn-default" id="nextButton" type="button" onclick="learningSkills()">Next Section</button>
				</div>
			</div>
		</div>
  </div>
