    ...
    <form class="form-horizontal" action="form.php?form=TraineeInformation" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
			  <p class="help-block col-lg-offset-2 col-lg-10">Enter your <b><i><u>full legal name</u></i></b> as it appears on your birth certificate or passport</p>
				...
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="traineeFirstName" placeholder="First name" value="" />
				</div>
			</div>
			<div class="form-group">
				<label for="traineeMiddleName" class="col-lg-2 control-label">Middle name</label>
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="traineeMiddleName" placeholder="Middle name" value="" />
				</div>
			</div>
			<div class="form-group">
				<label for="traineeLastName" class="col-lg-2 control-label">Last name *</label>
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="traineeLastName" placeholder="Last name" value="" />
				</div>
			</div>
      ...
      <div class="input-group col-lg-offset-2 col-lg-10">
        <button class="btn btn-default" id="nextButton" type="button" onclick="generalDetails()">Next Section</button>
      </div>
    </form>
  </div>
</div>
