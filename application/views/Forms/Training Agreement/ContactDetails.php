  ...
  <div class="contentContainer">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKRhNKbQ5FenPajhUyvBBemUoOwXKsTpE&libraries=places&callback=initAutocomplete" async defer></script>
			  ...
			  <div class="form-group">
				  ...
				  <div class="col-lg-10">
				    <input type="text" class="form-control" name="street_number" id="street_number" placeholder="Street number" value=""  />
				  </div>
			  </div>
        ...
        <div class="form-group">
				  ...
				  <div class="col-lg-10">
				    <input type="text" class="form-control" name="route" id="route" placeholder="Street address" value="" />
				  </div>
			  </div>
