  ...
  <div class="contentContainer">
    <form class="form-horizontal" action="form.php?form=EmployerInformation" method="post">
      ...
      <div class="form-group">
				...
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="mainContact" placeholder="Main contact name" value="" />
				</div>
			</div>
			<div class="form-group">
				<label for="contactDDI" class="col-lg-2 control-label">Employer contact DDI*</label>
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="contactDDI" placeholder="Main contact DDI" value="" />
				</div>
			</div>
			<div class="form-group">
				<label for="contactMobile" class="col-lg-2 control-label">Employer contact mobile</label>
				<div class="col-lg-10">
				  <input type="text" class="form-control" name="contactMobile" placeholder="Main contact mobile" value="" />
				</div>
			</div>
			<div class="form-group">
				<label for="contactEmail" class="col-lg-2 control-label">Employer contact email*</label>
				<div class="col-lg-10">
				  <input type="email" class="form-control" name="contactEmail" placeholder="Main contact email" value="" />
				</div>
			</div>
			<div class="input-group col-lg-offset-2 col-lg-10">
        <button class="btn btn-default" id="nextButton" type="button" onclick="employerInfo()">Next Section</button>
      </div>
		</form>
  </div>
</div>
